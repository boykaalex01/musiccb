...
def search_markup(
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="قفل", callback_data=f"forceclose {query}|{user_id}"
            ),
            InlineKeyboardButton(
                text=">", callback_data=f"popat 1|{query}|{user_id}"
            ),
...
def secondary_markup(videoid, user_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="🔗 بحث اكثر ", callback_data=f"other {videoid}|{user_id}"
            ),
            InlineKeyboardButton(text="قفل ", callback_data=f"close"),
        ],
    ]
    return buttons
...
audio_markup2 = InlineKeyboardMarkup(
    [
        ...
        [InlineKeyboardButton("قفل ", callback_data="close")],
    ]
)
